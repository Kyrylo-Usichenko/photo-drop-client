...
export default class MainProtected extends HttpClientProtected {
  ...
  public getSelfie = () => this.instance.get<any>(`/selfies`);

  public getUser = () => this.instance.get<any>(`/clients`);
  ...
  public resendUpdatePhone = (data: { phone_number: string }) =>
    this.instance.post<phoneResponse>("/clients/phone-number/resend", data);
